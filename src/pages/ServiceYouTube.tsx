  ...
  return (
    <ServicePageLayout
      ...
      deliverables={[
        ...
        { emoji: "🎞️", title: "Full post-production", description: "B-roll, motion graphics, kinetic captions, music, and pacing. Every deliverable is upload-ready for YouTube and Shorts.", accent: "from-purple-500 to-fuchsia-500", bg: "bg-purple-50" },
        ...
        { emoji: "🧱", title: "Creative library", description: "Every asset organized and reusable. Winning hooks, backgrounds, B-roll packs you can remix across campaigns forever.", accent: "from-amber-500 to-orange-500", bg: "bg-amber-50" },
      ]}
