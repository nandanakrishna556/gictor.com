...
export default function FrameModal({
  ...
  const { data: file } = useQuery({
    ...
    enabled: !!fileId,
    // Refetch based on BOTH local state AND file's actual status
  ...
  // Track if we've already shown toasts for current generation
                ...
                <div className="space-y-2">
                  ...
                  <div
                    className={cn(
                      ...
                      style === 'talking_head' ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'
                    )}
                    ...
                    {style === 'talking_head' && (
                      <div className="flex gap-1">
                        <Button
                          ...
                          onClick={(e) => { e.stopPropagation(); handleSubStyleChange('ugc'); }}
                        >
                          UGC
                        </Button>
                        <Button
                          ...
                          size="sm"
                          className="h-7 text-xs px-3"
                          onClick={(e) => { e.stopPropagation(); handleSubStyleChange('studio'); }}
                        >
                          Studio
                        </Button>
                      </div>
                  ...
                  <div
                    className={cn(
                      'flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all',
                      style === 'motion_graphics' ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50'
                    )}
