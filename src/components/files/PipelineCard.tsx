...
const ProcessingPreview: React.FC<{ 
  ...
  const showThumbnail = thumbnailUrl && (pipelineType === 'lip_sync' || pipelineType === 'talking_head' || pipelineType === 'clips' || pipelineType === 'b_roll');
...
export const PipelineCard: React.FC<PipelineCardProps> = ({ 
  ...
  const isVideo = pipelineType === 'lip_sync' || pipelineType === 'talking_head' || pipelineType === 'clips' || pipelineType === 'b_roll';
