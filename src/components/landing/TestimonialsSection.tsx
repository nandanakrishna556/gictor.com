      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center gap-10 md:gap-16">
          ...
          <div className="md:w-2/5">
            <h2 className="text-[28px] md:text-[36px] font-bold text-gray-900 tracking-tight leading-tight mb-6">
              Join 1,000+ businesses going viral with AI actors
            </h2>
            <Button className="bg-orange-600 hover:bg-orange-700 text-white rounded-full px-7 py-3 text-[15px] font-semibold" asChild>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-[15px] font-bold text-gray-900">Sarah K.</p>
                  <p className="text-[14px] text-gray-500">DTC Brand Owner</p>
                </div>
              </div>
