...
export default function BRollFirstFrameStage({ pipelineId, onComplete }: BRollFirstFrameStageProps) {
  ...
  useEffect(() => {
    ...
    // DO NOT set localGenerating here - isServerProcessing handles active generation detection
  ...
  const inputContent = (
    <div className="space-y-5">
      ...
      {inputMode === 'upload' ? (
        ...
        /* Generate Mode UI */
        <>
          {/* Frame Type - First Frame pre-selected and locked */}
  ...
  const wasAIGenerated = (pipeline?.first_frame_input as any)?.mode === 'generate';
