      ...
      <div className="container-page">
        <div className="reveal mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-3 text-4xl font-black tracking-[-0.02em] text-gray-950 md:text-5xl lg:text-6xl">
            Built for every <em className="text-gradient-orange not-italic-reset" style="font-style:italic">creative team.</span>
          </h2>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="mt-8 border-t border-gray-100 pt-6">
                <div className="text-4xl font-black tracking-[-0.02em] text-gray-950 md:text-5xl">
                  <em className="text-gradient-orange not-italic-reset" style="font-style:italic">{tab.metric.value}</span>
                </div>
