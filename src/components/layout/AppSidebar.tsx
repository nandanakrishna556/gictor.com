...
import { ChevronDown, Plus, Layers, MoreHorizontal, Trash2, Pencil, Check, X, Coins, Sun, Moon, LayoutDashboard, Settings, UserCircle, CreditCard } from 'lucide-react';
  ...
  return (
    <aside className="flex h-screen w-60 shrink-0 flex-col bg-sidebar gradient-sidebar border-r border-sidebar-border overflow-hidden">
      ...
      <div className="shrink-0 border-t border-sidebar-border px-3 py-3 space-y-0.5">
        ...
        >
          <CreditCard className="h-[18px] w-[18px]" strokeWidth={1.5} />
